    ...
    return (
            ...
            <div className="h-screen w-full mt-16  ">
               ...
               <h1 className="font-mon text-gray-500 text-xl font-semibold max-w-[750px] border-b-2 mx-auto pt-12">Create Post</h1>
                ...
                <div className=" max-w-[750px] h-fit bg-white border-4 mx-auto mt-4 rounded-[4px] " >
                    <div className=" w-full h-16 border-b-2 flex  items-center">
                        ...
                        <div className={page === 1 ? 'flex items-center cursor-pointer bg-gray-100 h-full' : 'flex items-center cursor-pointer hover:bg-gray-100 h-full'} onClick={() => setPage(1)}>
                            ...
                            <h1 className="pr-6 border-r-2 py-2 sm:py-3 font-mon font-semibold text-gray-500 text-sm sm:text-lg ">image & video</h1>
                        </div>
                        <div className={page === 2 ? 'flex items-center cursor-pointer bg-gray-100 h-full' : 'flex items-center cursor-pointer hover:bg-gray-100 h-full'} onClick={() => setPage(2)}>
                            ...
                            <h1 className="pr-6 sm:border-r-2 py-3 font-mon font-semibold text-gray-500 text-lg">Poll</h1>
                        </div>
                        <div className="ml-auto hidden sm:flex text-violet-500 border-violet-500 w-fit h-8 border-4 items-center justify-center rounded-xl  hover:bg-violet-500  hover:scale-110 mr-5 cursor-pointer  hover:text-white">
                    ...
                    <div className="w-full border-b-2 h-fit  ">
                        ...
                        <div className="ml-auto flex sm:hidden text-violet-500 border-violet-500 w-fit h-8 border-4 items-center justify-center rounded-xl  hover:bg-violet-500  hover:scale-110 mr-5 cursor-pointer  hover:text-white">
                            <HiLightningBolt size={20} className=" ml-auto pl-1 pointer-events-none z-10 text-yellow-500" />
                            <h1 className=" font-bold  font-mon text-sm pr-2  ">buy Boost</h1>
                        </div>
