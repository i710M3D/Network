    ...
    return ( 
        ...
        <div className=" sm:scale-100 sm:w-[600px] scale-90 mx-auto h-fit relative mt-12 pt-4  ">
            <div className="w-[90%] flex justify-between  sm:px-10 my-5  mx-auto relative ">    
                <h1 className= {`text-[32px] font-mon font-semibold  cursor-pointer  sm:scale-100 sm:no-underline sm:opacity-100 ${hr ? `text-[#0183FF] sm:text-black scale-105 ease-in-out duration-200  underline` :`scale-90 opacity-95`}`}  onClick={() => Funhr(true)}>Home</h1>
                <h1 className={`text-[32px] font-mon font-semibold  cursor-pointer  sm:scale-100 sm:no-underline sm:opacity-100 ${hr ? `scale-90 opacity-95` :`text-[#0183FF] sm:text-black scale-105 ease-in-out duration-200  underline`}`}  onClick={() => Funhr(false)}>Recommended</h1>
                <div className={`hidden sm:block h-[6px]  rounded-full bg-[#0183FF] absolute bottom-0 left-0 ease-in-out duration-300 scale-100 ${ hr ? ' -translate-x-2 sm:translate-x-8  w-[117px]' : ' translate-x-32 sm:translate-x-[237px]   w-[282px]'} `  }></div>
            </div>
